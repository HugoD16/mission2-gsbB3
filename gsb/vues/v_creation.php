          ...
          <div class="box">
            <div class="content-wrap">
              ...
              <form method="post" action="index.php?uc=creation&action=valideCreation">
                ...
                <!-- Checkbox pour activer le bouton Créer -->
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="acceptTerms" onchange="toggleSubmitButton()">
                  <p>En cochant cette case, vous acceptez notre <a href"v_politiqueprotectiondonnees.php">politique de protection des données<a></p>
                </div>
                
                <br>
                <input type="submit" id="submitButton" class="btn btn-primary signup" value="Créer" disabled />
              </form>
            </div>
          </div>
        </div>
